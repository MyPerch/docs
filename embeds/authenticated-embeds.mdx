...
### Lead Management
Our first authenticated embed combining lead submission and review widgets for mortgage professionals. Available as both static widgets (predefined configurations) and custom configurations.
