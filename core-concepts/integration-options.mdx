...
<Steps>
  ...
  <Step title="Track Leads">
    Track leads and monitor for conversion
  </Step>
  <Step title="Monitor Deals">
    Track converted lead deals and gain access to key insights like deal status and pre-approvals
  </Step>
  <Step title="Take Action">
    Take action and earn commission when deals fund
  </Step>
</Steps>
