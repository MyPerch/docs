...
description: "Perch offers three integration options, each designed for different partner needs and technical capabilities. Choose the approach that best fits your business model and requirements"
---

Perch offers three integration options, each designed for different partner needs and technical capabilities. Choose the approach that best fits your business model and requirements. Before choosing your integration options it may be beneficial to learn about how Perch has structured our [core API resources (Leads & Plans)](/core-concepts/leads-and-plans) to help facilitate your decision.
...
Drive referrals to Perch by sharing your **Referral Link** on your website, social media, in your email signature, etc. or by embedding one of Perch's [embeddable tools](/embeds/overview) and earn a commission on each funded deal.
...
<Steps>
  <Step title="Drive Traffic">
    Referral Links & Widgets direct users to Perch's customizable [sign-up page](https://app.myperch.io/auth/sign-up?referralCode=EXAMPLE) with your referral code, company logo (or photo) and a customizable welcome message.
  </Step>
...
- Read about [embeds](/embeds/overview) to explore how you can to embed our tools into your CRM
...
- Contact your Perch representative for API credentials or book an API demo
- For automated lead submission without full API development, consider our Zapier integration
...
| Integration Option | Data Access | Client Name | Application Status | Technical Requirements |
|------------------|-------------|------------|-------------------|----------------------|
