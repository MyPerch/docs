...
<Steps>
  ...
  <Step title="Client Signs Up">
    Users sign up and are automatically tagged with your referral attribution. You're notified via email when a client signs up and when their deal funds. In addition to email alerts, you can also track your referrals [via API](/getting-started/overview) and through our [lead submission tools](/embeds/lead-management).
